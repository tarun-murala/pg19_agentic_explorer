...
class Settings(BaseSettings):
    ...
    llm_model: str = Field(default="codellama:latest", description="Model used for analyzer/answer agents")
    ollama_base_url: str = Field(default="http://localhost:11434", description="Ollama HTTP endpoint")
