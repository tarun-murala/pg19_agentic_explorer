...
class Settings(BaseSettings):
    ...
    llm_model: str = Field(default="codellama:latest", description="Model used for entity extraction")
    ollama_base_url: str = Field(default="http://localhost:11434", description="Base URL for Ollama")
